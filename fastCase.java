...
public class FastCash extends JFrame implements ActionListener {
    ...
    JButton deposit , withdrawl , ministatement , pinchange , fastcase , balanceenquiry  , back;
    String pinnumber;
                  ...
                  if(ae.getSource() ==back){
                      ...
                      try{
                          ...
                          if (ae.getSource() != exit && balance < Integer.parseInt(amount)){
                              JOptionPane.showMessageDialog(null, " Insuffinent Balance ");
                              return ;
                          ...
                          String query = "insert into bank values( '"+pinnumber+"' , '"+date+"', 'Withdrawl' , '"+amount+"' )"
                                  ...
                                  JOptionPane.showMessageDialog(null,"RS " + amount + "Debited Sucessfully" ae);
